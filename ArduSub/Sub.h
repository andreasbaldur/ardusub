...
// Andreas: Originally private. Made public so that AC_PosControl can print.
//private:
...
# include USERHOOK_VARIABLES
 ...
 #error Unrecognised frame type
    ...
    static void gcs_send_text(MAV_SEVERITY severity, const char *str);
    ...
    void tuning();
    // Andreas: Added static
    static void gcs_send_text_fmt(MAV_SEVERITY severity, const char *fmt, ...);
